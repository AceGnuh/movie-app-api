export const FILM_MESSAGE = {
  CREATE: 'Film has been created successfully',
  UPDATE: 'Film has been updated successfully',
  DELETE: `Film has been deleted successfully`,
};

export const FILM_ERROR_MESSAGE = {
